...
from util.config import  mongo_db, mongo_collection_name, rapiminer_files_direct,search_keys, config_counter, config_positive_counter, config_negative_counter, config_trials
...
class Harvest:
    ...
    mongo = Mongo()
    collectionObject = mongo.connect(mongo_host, mongo_port, mongo_db, mongo_collection_name)
                ...
                try:
                    for contentFile in paginated_list_of_search_results:
                        ...
                        if ET_object != -1:
                            ...
                            ET_object_mongo['sha'] = contentFile.sha
